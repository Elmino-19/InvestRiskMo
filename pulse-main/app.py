...
def load_particles_config():
    with open('/home/erfan/PycharmProjects/questionarie/pulse-main/particles_config.html', 'r') as file:
        return file.read()
...
local_css('/home/erfan/PycharmProjects/questionarie/pulse-main/style.css')
...
def fetch_stock_tickers(instrument_type):
    try:
        ...
        df = pd.read_csv('/home/erfan/PycharmProjects/questionarie/pulse-main/all_stocks.csv')
...
def fetch_data_by_ticker_and_date_range(isin, start_date, end_date):
    try:
        ...
        if ticker_data.empty:
            ...
            stocks_df = pd.read_csv('/home/erfan/PycharmProjects/questionarie/pulse-main/all_stocks.csv')
